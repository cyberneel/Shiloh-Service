...
//  Shiloh Service
//
//  Created by Neelesh Chevuri on 2/20/25.
//
...
struct Scene4: View {
    let storyChunks = [
        ...
        "That would have taken us forever if it weren’t for you.",
        "Now, we can till the soil.",
        "...",
        "Oh, you want to help again? GREAT!",
    ]
    ...
    var body: some View {
        if sceneDone == false {
            ...
            TillingGameView().transition(.blurReplace)
        }
    }
...
struct Scene4View_Previews: PreviewProvider {
